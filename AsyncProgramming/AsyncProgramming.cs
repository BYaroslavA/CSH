    ...
    internal class AsyncProgramming
    {
        ...
        public void Run()
        {
            ...
            do
            {
                ...
                Console.WriteLine("5. Multi Thread demo ");
                ...
                Console.WriteLine("----------------------------------");
                Console.WriteLine("9. HW: Tasks Random Numbers ");

                Console.WriteLine("a. HW: Async/Await Random Numbers");
                Console.WriteLine("b. HW: String Tasks Chain ");

                Console.WriteLine("c. HW: Async HTML Downloader"); 
                ...
                switch (keyInfo.KeyChar)
                {
                    ...
                    case 'c': HomeworkHtmlDownloaderLaunch(); PressAnyKey(); break; 
